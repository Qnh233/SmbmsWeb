...
function deleteProvider(obj){
	...
	$.ajax({
		...
		data:{method:"delete",proid:obj.attr("proid")},
		// dataType:"json",
...
$(function(){
	$(".viewProvider").on("click",function(){
		...
		window.location.href=path+"/ProviderServlet?method=BackDateV&proid="+ obj.attr("proid");
	});
	...
	$(".modifyProvider").on("click",function(){
		...
		window.location.href=path+"/ProviderServlet?method=BackDateM&proid="+ obj.attr("proid");
	});
