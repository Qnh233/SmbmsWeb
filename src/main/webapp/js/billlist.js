...
function deleteBill(obj){
	...
	$.ajax({
		...
		data:{method:"delete",billid:obj.attr("billid")},
		// dataType:"json",
...
$(function(){
	$(".viewBill").on("click",function(){
		...
		window.location.href=path+"/BillServlet?method=BackDateV&billid="+ obj.attr("billid");
	});
	...
	$(".modifyBill").on("click",function(){
		...
		window.location.href=path+"/BillServlet?method=BackDateM&billid="+ obj.attr("billid");
	});
	$('#no').click(function () {
		cancleBtn();
	});
